# 「AIを入れたら顧客情報が漏れた」を防ぐ｜中小企業のためのAIセキュリティ チェックリスト
...
> **最終更新：2026年4月17日**｜AIサービスの仕様・プラン・設定画面は頻繁に変わります。実施前に各サービスの公式ヘルプで最新情報を必ず確認してください。
...
- この記事のテンプレート・設定手順の利用は**すべて自己責任**です。筆者は利用結果について一切の責任を負いません
- テンプレートはあくまで雛形です。**自社の業種・規模・業務内容に合わせて必ずカスタマイズ**してください
- AIサービスの設定画面やプラン内容は変更される場合があります。最新の情報は各サービスの公式サイトで確認してください

## なぜ中小企業でセキュリティ事故が起きるのか

大企業には情報セキュリティの専門チームがいます。ガイドラインがあり、監査があり、違反したら処分がある。

中小企業にはそれがない。だから事故が起きる——と思うかもしれないけど、違います。**事故に気づかない**んです。
...
チェックリストの前に、「考え方の軸」を整理します。ルールは変わるけど、判断基準は変わらないので。
...
むしろ新人のほうがマシかもしれない。新人は「わからない」と言うけど、**AIは自信満々に間違える**ので。
...
知らないことは罪じゃない。でも、**知らないまま使い続けるのは事故**です。
...
**ここから先は、そのまま社内で使える3つの成果物を掲載しています。**

- AI利用規程テンプレート（全8条・空欄を埋めるだけで使える）
- 入力禁止情報リスト（印刷してデスクに貼るA4一枚）
- AIサービス別セキュリティ設定手順（ChatGPT・Claude・Gemini）
...
なお、AIサービス各社のプライバシー方針は頻繁に変わります。以下の情報は**2026年4月17日時点**のものです。実施前に各サービスの公式ヘルプで最新情報を確認してください。
...
**⚠️ 重要な変更：** 2025年8月29日にAnthropicのプライバシー方針が変わり、**無料版・Pro・Maxプランは「デフォルトで会話内容がモデル学習に使用される」方式に変更**されました。以前「学習に使わない」と案内していた情報は古いので注意してください。
...
無料版のChatGPTで業務をしている会社が、想像以上に多い。月額数千円をケチって、顧客情報を学習データに提供している。**割に合わない節約**です。
...
**回避策：** **経営者が方針を決め、情シスが仕組みを作り、各部署のリーダーが現場に浸透させる**。この三層構造がないと、ルールは絵に描いた餅です。情シスに丸投げする経営者は、セキュリティ事故の共犯者だと僕は思っています。
